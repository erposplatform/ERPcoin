...
This mechanism has been integrated into Bitcore-Node-ERPcoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/erpcoinpay/insight-api-erpcoin#web-socket-api](https://github.com/erpcoinpay/insight-api-erpcoin#web-socket-api)
* API: [https://github.com/erpcoinpay/insight-api-erpcoin#instantsend-transactions](https://github.com/erpcoinpay/insight-api-erpcoin#instantsend-transactions)
...
By default, the ERPcoin Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the ERPcoin Core daemon:
