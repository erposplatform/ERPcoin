...
This document provides guidelines for internationalization of the ERPcoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `erpcoin_en.ts` remains unchanged.
