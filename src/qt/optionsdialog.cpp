    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("ERP-light"), QVariant("light"));
    ui->theme->addItem(QString("ERP-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("ERP-light-retro"), QVariant("light-retro"));
    ui->theme->addItem(QString("ERP-light-hires-retro"), QVariant("light-hires-retro"));
    ui->theme->addItem(QString("ERP-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("ERP-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("ERP-traditional"), QVariant("trad"));
