    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  erpcoin-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the ERPcoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 ERP, 0.1 ERP, 1 ERP and 10 ERP -- sort of like the paper money you use every day.</li> \
