...
//! Discourage users to set fees higher than this amount (in Simbian) per kB
static const CAmount HIGH_TX_FEE_PER_KB = 0.01 * COIN;
//! -maxtxfee will warn if called with a higher fee than this amount (in Simbian)
...
/** Absolute maximum transaction fee (in Simbian) used by wallet and mempool (rejects high fee in sendrawtransaction) */
