/* src/config/erpcoin-config.h.  Generated from erpcoin-config.h.in by configure.  */
/* src/config/erpcoin-config.h.in.  Generated from configure.ac by autoheader.  */
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The ERPcoin Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "ERPcoin Core"
...
#define PACKAGE_BUGREPORT "https://github.com/erpcoinpay/erpcoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "ERPcoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "ERPcoin Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "erpcoincore"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://erpcoin.org/"
