...
BOOST_AUTO_TEST_CASE(addrman_select)
{
    ...
    CService addr3 = ResolveService("250.3.2.2", 7450);
    CService addr4 = ResolveService("250.3.3.3", 7450);
    ...
    BOOST_CHECK(addrman.Select().ToString() == "250.3.2.2:7450");
    BOOST_CHECK(addrman.Select().ToString() == "250.3.3.3:7450");
...
BOOST_AUTO_TEST_CASE(addrman_find)
{
    ...
    CAddress addr2 = CAddress(ResolveService("250.1.2.1", 7450), NODE_NONE);
...
BOOST_AUTO_TEST_CASE(addrman_getaddr)
{
    ...
    CAddress addr2 = CAddress(ResolveService("250.251.2.2", 7450), NODE_NONE);
...
BOOST_AUTO_TEST_CASE(caddrinfo_get_tried_bucket)
{
    ...
    CAddress addr2 = CAddress(ResolveService("250.1.1.1", 7450), NODE_NONE);
