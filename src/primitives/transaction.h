...
public:
    ...
    {
        // "Dust" is defined in terms of CTransaction::minRelayTxFee, which has units Simbian-per-kilobyte.
        // If you'd pay more than 1/3 in fees to spend something, then we consider it dust.
        // A typical spendable txout is 34 bytes big, and will need a CTxIn of at least 148 bytes to spend
        // i.e. total is 148 + 32 = 182 bytes. Default -minrelaytxfee is 1000 Simbian per kB
        // and that means that fee per spendable txout is 182 * 1000 / 1000 = 182 Simbian.
        // So dust is a spendable txout less than 546 * minRelayTxFee / 1000 (in Simbian)
        // i.e. 182 * 3 = 546 Simbian with default -minrelaytxfee = minRelayTxFee = 1000 Simbian per kB.
