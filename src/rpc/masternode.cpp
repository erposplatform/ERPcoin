...
UniValue masternodelist(const JSONRPCRequest& request)
{
                ...
                strMode != "rank" && strMode != "sentinel" && strMode != "status"))
    {
        throw std::runtime_error(
                ...
                "  payee          - Print ERPcoin address associated with a masternode (can be additionally filtered,\n"
                "                   partial match)\n"
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "erpcoin",               "masternode",             &masternode,             true,  {} },
    { "erpcoin",               "masternodelist",         &masternodelist,         true,  {} },
    { "erpcoin",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "erpcoin",               "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "erpcoin",               "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
    { "erpcoin",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
