...
class WalletTest (BitcoinTestFramework):
    ...
    def run_test (self):
        ...
        # Send 210 ERP from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 1000 ERP in block rewards plus fees, but
        ...
        # Send 100 ERP with subtract fee from amount
        ...
        # Sendmany 100 ERP with subtract fee from amount
